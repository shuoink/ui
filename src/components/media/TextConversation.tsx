...
const Tail: FC<JSX.IntrinsicElements['svg']> = props => (
...
export const TextMessage: FC<{from: 'me' | 'them'; children?: ReactNode}> = ({
  from,
  children,
}) => {
  ...
  return (
    <div
      ref={ref}
      className={clsx('relative max-w-[75%] opacity-0 translate-y-[100px]', {
        'self-end': from === 'me',
